...
public sealed class AudioConversionService
{
    ...
    public AudioConversionService(ToolPreparationService toolPreparationService)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        string jobId = SandboxPathService.CreateJobId("audio-convert");
        ...
        var arguments = FfmpegArgumentBuilder.BuildAudioArguments(inputFile, sandboxOutputFile, outputFormat, threadCount);

        AppLog.Info("[ffmpeg] Audio conversion started.");
